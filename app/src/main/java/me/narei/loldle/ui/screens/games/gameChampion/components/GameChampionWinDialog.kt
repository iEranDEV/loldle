...
import me.narei.loldle.ui.screens.games.gameChampion.GameChampionAction
import me.narei.loldle.ui.theme.CustomColor
import me.narei.loldle.ui.theme.spacing

@Composable
fun GameChampionWinDialog(
    modifier: Modifier = Modifier,
    championToGuess: Champion,
    navigateBack: () -> Unit,
    onAction: (GameChampionAction) -> Unit
) {
    ...
    Dialog (
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    text = "You successfully guessed champion (${championToGuess.name}). What do you want to do next?",
                ...
                Column(
                    ...
                    AppButton(
                        onClick = { onAction(GameChampionAction.ResetGame) },
                        title = "Play Again",
