package me.narei.loldle.ui.screens.games.gameSkin.components
...
import me.narei.loldle.ui.screens.games.gameSkin.GameSkinAction
import me.narei.loldle.ui.theme.CustomColor
import me.narei.loldle.ui.theme.spacing

@Composable
fun GameSkinWinDialog(
    modifier: Modifier = Modifier,
    championToGuess: Champion,
    skinToGuess: Skin,
    navigateBack: () -> Unit,
    onAction: (GameSkinAction) -> Unit
) {
    ...
    Dialog (
        ...
        Surface(
            ...
            Column(
                ...
                AsyncImage(
                    model = skinToGuess.url,
                    contentDescription = "Skin ${skinToGuess.name}",
                    modifier = Modifier.fillMaxWidth().aspectRatio(16 / 9f)
                )

                Text(
                    text = "You successfully guessed champion (${championToGuess.name}) and skin ${skinToGuess.name}.\nWhat do you want to do next?",
                ...
                Column(
                    ...
                    AppButton(
                        onClick = { onAction(GameSkinAction.ResetGame) },
                        title = "Play Again",
